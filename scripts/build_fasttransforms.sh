...
#
# Usage:
#   scripts/build_fasttransforms.sh --homebrew
#   scripts/build_fasttransforms.sh --prefix "$HOME/micromamba/envs/hp2sph-omp"
#   scripts/build_fasttransforms.sh --prefix <env> --source /path/to/FastTransforms
#
...
To use threads, confirm one runtime and then opt in:
    ...
    python -c "from hp2sph import _openmp; print(_openmp.runtime_paths())"
